...
class RunIndexRow(TimestampMixin, Base):
    ...
    instance_area_um2 = Column(String(64), nullable=False, default="")
    stdcell_area_um2 = Column(String(64), nullable=False, default="")
    stdcell_count = Column(String(64), nullable=False, default="")
    core_area_um2 = Column(String(64), nullable=False, default="")
    utilization_pct = Column(String(64), nullable=False, default="")
