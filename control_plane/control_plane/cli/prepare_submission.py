"""CLI for preparing a bot-owned submission branch from a review package."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Prepare a bot-owned branch/worktree from a published review package")
