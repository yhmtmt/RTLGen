...
_DECODER_EVIDENCE_OUTPUT_KEYS: tuple[tuple[str, str], ...] = (
    ...
    (
        "attention_mixed_int8_q24_pwl_native_quality_out",
        "attention_mixed_int8_q24_pwl_native_quality_report",
    ),
    (
    ...
    (
        "attention_mixed_int8_score32_w16_rtl_exact_generation_quality_out",
    ...
    (
        "decode_score_multivalue_cluster_equivalence_out",
...
def _decoder_evidence_summary(*, evidence_ref: str, evidence_payload: dict[str, Any]) -> tuple[str, str]:
    ...
    if model == "llm_decoder_attention_decode_score_multivalue_cluster_equivalence_v1":
        outcome = str(evidence_payload.get("decision") or "decode_score_multivalue_cluster_equivalence_recorded")
        parts = [
            f"Decoder score multivalue-cluster equivalence recorded from {evidence_ref}: decision={outcome}",
        ]
        for key in (
            "equivalence_pass",
            "semantic_profile",
            ...
            "value_slices",
            "value_dimensions",
            "score_passes_per_command",
            "score_writes_per_block",
            "score_reads_per_block",
    ...
    if model == "llm_decoder_attention_mixed_int8_quality_backed_frontier_llama7b_v1":
        ...
        for key in (
            ...
            "score32_generation_quality_pass",
