...
- last_submission_failure: `Command '['git', '-C', '/tmp/rtlgen-noc-contention', 'worktree', 'add', '-b', 'eval/l2_decoder_attention_kv_endpoint_full_onchip_service_schedule_softmax_recip_lut_llama7b_v1/s20260617t042256z', '/tmp/rtlgen-submissions/repo', 'refs/remo...`
- final_submission_pr: `https://github.com/yhmtmt/RTLGen/pull/879`
