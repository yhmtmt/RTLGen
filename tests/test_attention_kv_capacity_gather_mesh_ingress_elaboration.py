...
RTL_FILES = [
    "npu/sim/rtl/attention_kv_paired_key_address.sv",
...
def test_complete_capacity_gather_mesh_ingress_elaborates(tmp_path: Path, paired: int) -> None:
    ...
    result = subprocess.run(
        [
            "iverilog",
            "-g2012",
            f"-Pattention_kv_capacity_gather_mesh_ingress.PAIRED_K={paired}",
            "-s",
