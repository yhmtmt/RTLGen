...
- `docs/proposals/prop_l1_terminal_sigmoid_block_v1/design_brief.md`
- `docs/proposals/prop_l1_terminal_sigmoid_block_v1/evaluation_gate.md`
- `docs/proposals/prop_l1_terminal_sigmoid_block_v1/implementation_summary.md`
- `docs/proposals/prop_l1_terminal_sigmoid_block_v1/quality_gate.md`
- `docs/proposals/prop_l1_terminal_sigmoid_block_v1/analysis_report.md`
- `docs/proposals/prop_l1_terminal_sigmoid_block_v1/promotion_decision.json`
- `docs/proposals/prop_l1_terminal_sigmoid_block_v1/promotion_result.json`
- `docs/proposals/prop_l1_terminal_sigmoid_block_v1/promotion_gate.md`
- `docs/proposals/prop_l1_terminal_sigmoid_block_v1/evaluation_requests.json`
