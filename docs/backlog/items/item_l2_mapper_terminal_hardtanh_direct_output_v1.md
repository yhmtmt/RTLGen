# Terminal hardtanh direct output

- item_id: `item_l2_mapper_terminal_hardtanh_direct_output_v1`
- layer: `layer2`
- kind: `mapper`
- status: `promoted_to_proposal`
- priority: `medium`
- owner: `developer_agent`
- created_utc: `2026-03-26T12:30:00Z`
- updated_utc: `2026-03-26T12:30:00Z`
...
## Summary
- extend the bounded terminal vec-op direct-output path to terminal `HardTanh` on fixed `nm1`
- stage the work as a merged `measurement_only` baseline first, then a paired fused comparison

## Dependencies
- accepted lower-layer source: `prop_l1_npu_nm1_hardtanh_vec_enable_v1`
