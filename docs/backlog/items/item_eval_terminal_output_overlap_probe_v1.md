...
- proposal_path: `docs/proposals/prop_cross_terminal_output_overlap_probe_v1`
- triggered_by_proposal: `prop_l2_softmax_tile_fusion_v1`
- triggering_evidence:
  - `docs/proposals/prop_l2_softmax_tile_fusion_v1/analysis_report.md`
...
## Promotion Outcome
- promoted to `docs/proposals/prop_cross_terminal_output_overlap_probe_v1`
- promotion rationale:
