...
- proposal_path: `docs/proposals/prop_cross_non_mlp_terminal_suite_v1`
...
- triggering_evidence:
  ...
  - `docs/proposals/prop_cross_terminal_output_overlap_probe_v1/promotion_decision.json`
...
- proposal result:
  - `docs/proposals/prop_cross_non_mlp_terminal_suite_v1/promotion_result.json`
- closing note:
