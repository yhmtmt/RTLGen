...
- proposal_path: `docs/proposals/prop_l1_npu_nm1_tanh_vec_enable_v1`
...
- triggering_evidence:
  ...
  - `docs/proposals/prop_l1_terminal_tanh_block_v1/promotion_decision.json`
  - `docs/proposals/prop_l2_mapper_terminal_activation_family_v1/promotion_result.json`
...
## Inputs / Sources
- `docs/proposals/prop_l1_terminal_tanh_block_v1/analysis_report.md`
- `docs/proposals/prop_l1_terminal_tanh_block_v1/promotion_result.json`
