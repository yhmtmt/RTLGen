# Terminal int8 HardSwish retry/resume proof block

- item_id: `item_l1_terminal_hardswish_retryresume_v1`
- layer: `layer1`
- kind: `circuit`
...
- proposal_path: `docs/proposals/prop_l1_terminal_hardswish_retryresume_v1`
...
## Candidate Idea
- queue one fresh standalone HardSwish block under a unique canonical design path and use it to prove dashboard `Resume` recovery

## Why It Might Matter
- validates the new dashboard resume flow on a normal proposal-backed Layer 1 item
- keeps the proof cheap by reusing the accepted HardSwish wrapper shape
...
## Inputs / Sources
- `runs/designs/activations/terminal_hardswish_int8_pwl_wrapper/config_terminal_hardswish_int8_pwl.json`
- `runs/designs/activations/sweeps/nangate45_terminal_hardswish_int8_pwl_v1.json`
- `docs/proposals/prop_l1_terminal_hardswish_block_v1/proposal.json`
