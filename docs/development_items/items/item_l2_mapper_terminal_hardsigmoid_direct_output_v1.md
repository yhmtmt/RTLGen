...
- triggering_evidence:
  ...
  - `docs/developer_loop/prop_l1_npu_nm1_hardsigmoid_vec_enable_v1/analysis_report.md`
  - `docs/developer_loop/prop_l1_npu_nm1_hardsigmoid_vec_enable_v1/promotion_decision.json`
