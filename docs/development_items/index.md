...
| `item_l2_mapper_terminal_activation_family_v1` | `layer2` | `mapper` | `Terminal activation-family direct output` | `blocked_on_l1_prerequisite` | `medium` | `developer_agent` | `prop_l2_mapper_terminal_activation_family_v1` | `2026-03-19T14:05:00Z` |
...
| `item_l1_npu_nm1_sigmoid_vec_enable_v1` | `layer1` | `circuit` | `NPU nm1 sigmoid vec enable` | `promoted_to_proposal` | `high` | `developer_agent` | `prop_l1_npu_nm1_sigmoid_vec_enable_v1` | `2026-03-19T13:10:00Z` |
