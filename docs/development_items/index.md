...
| `item_eval_non_mlp_terminal_suite_v1` | `cross` | `architecture` | `Non-MLP terminal-op suite` | `promoted_to_proposal` | `high` | `developer_agent` | `prop_cross_non_mlp_terminal_suite_v1` | `2026-03-18T11:05:00Z` |
