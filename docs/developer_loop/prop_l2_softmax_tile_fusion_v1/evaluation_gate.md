...
- status: approved
- approved_by: `user`
- approved_utc: `2026-03-16T05:10:58Z`
- allowed_evaluations:
...
- note: `quality_gate.md` passed. This proposal is now waiting only for human evaluation-spend approval before remote Layer 2 campaigns are enqueued.
