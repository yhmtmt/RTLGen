...
- `baseline_schedule`: `docs/developer_loop/prop_l2_softmax_tile_fusion_v1/quality_report_artifacts/baseline_schedule.yml`
- `candidate_schedule`: `docs/developer_loop/prop_l2_softmax_tile_fusion_v1/quality_report_artifacts/candidate_schedule.yml`
- `baseline_descriptors`: `docs/developer_loop/prop_l2_softmax_tile_fusion_v1/quality_report_artifacts/baseline_descriptors.bin`
- `candidate_descriptors`: `docs/developer_loop/prop_l2_softmax_tile_fusion_v1/quality_report_artifacts/candidate_descriptors.bin`
- `baseline_trace`: `docs/developer_loop/prop_l2_softmax_tile_fusion_v1/quality_report_artifacts/baseline_trace.json`
- `candidate_trace`: `docs/developer_loop/prop_l2_softmax_tile_fusion_v1/quality_report_artifacts/candidate_trace.json`
