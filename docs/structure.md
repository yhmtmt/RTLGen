...
| `docs/development_items/` | Development intake backlog | Preliminary L1/L2 item registry before proposal promotion. |
...
5. Development intake backlog: `docs/development_items/README.md` + `docs/development_items/index.md`
6. Developer-agent review contract: `docs/developer_agent_review.md`
7. Developer-agent artifact schemas: `docs/developer_agent_artifacts.md`
8. Developer-agent orchestration procedure: `docs/developer_agent_orchestration.md`
9. Layer 1 runbook: `docs/layer1_circuit_workflow.md`
10. Layer 2 runbook: `npu/docs/workflow.md`
11. NPU current snapshot: `npu/docs/status.md`
12. NPU plan detail: `npu/docs/*_plan.md` + `npu/synth/plan.md`
13. Cross-domain notes and rationale: `notes/*.md`
