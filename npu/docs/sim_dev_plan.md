...
- FP16-3 progressed: fp16 VEC (`add/mul/relu/gelu/softmax/layernorm/dgelu/dsoftmax/dlayernorm`) path is wired with C++ IEEE `fp_mac` backend and perf/RTL comparison hooks.
