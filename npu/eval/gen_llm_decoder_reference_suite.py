#!/usr/bin/env python3
"""Generate reference-only decoder fixtures for llm_decoder_eval_tiny_v1."""
...
def main() -> int:
    ...
    parser.add_argument(
        '--out-dir',
        default='runs/datasets/llm_decoder_eval_tiny_v1/reference',
        help='Directory for per-sample reference JSON files.',
    )
    parser.add_argument(
        '--out-manifest',
        default='runs/datasets/llm_decoder_eval_tiny_v1/reference_manifest.json',
        help='Path for generated reference manifest.',
    )
    ...
    for sample in samples:
        doc = build_decoder_reference_doc(
        ...
        manifest_samples.append(
            {
                ...
                'reference_json': _portable_path(out_path),
