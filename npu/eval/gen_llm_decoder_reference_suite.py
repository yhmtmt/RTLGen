...
def main() -> int:
    ...
    parser.add_argument('--out-dir', default='runs/datasets/llm_decoder_eval_tiny_v1/reference')
    parser.add_argument('--out-manifest', default='runs/datasets/llm_decoder_eval_tiny_v1/reference_manifest.json')
