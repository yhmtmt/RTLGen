...
- Floating-point coverage includes fp16 GEMM (builtin placeholder and C++ IEEE-half lane-1) and fp16 VEC (`add/mul/relu/gelu/softmax/layernorm`) via RTL/perf compare.
- bf16/fp8 and fp16 derivative-vector numeric equivalence are not covered yet.
