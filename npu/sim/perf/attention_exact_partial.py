...
def exact_partial_pair_merge_capture_to_output_latency_cycles() -> int:
    return PAIR_CAPTURE_TO_OUTPUT_LATENCY_CYCLES


def exact_partial_pair_merge_compute_launch_to_output_latency_cycles() -> int:
    return PAIR_COMPUTE_LAUNCH_TO_OUTPUT_LATENCY_CYCLES


def exact_partial_pair_merge_compute_launch_interval_cycles() -> int:
    return PAIR_COMPUTE_LAUNCH_INTERVAL_CYCLES


def simulate_exact_partial_pair_merge_service(
    *,
    pair_count: int,
    ...
    accept_cycles = list(range(count))
    ...
    for _ in range(count):
        ...
        output_valid_cycle = launch_cycle + PAIR_COMPUTE_LAUNCH_TO_OUTPUT_LATENCY_CYCLES
        ...
        launch_cycle = output_fire_cycle + 2
    return {
        "pair_count": count,
        ...
        "capture_to_output_latency_cycles": PAIR_CAPTURE_TO_OUTPUT_LATENCY_CYCLES,
        "compute_launch_to_output_latency_cycles": PAIR_COMPUTE_LAUNCH_TO_OUTPUT_LATENCY_CYCLES,
        "compute_launch_interval_cycles": PAIR_COMPUTE_LAUNCH_INTERVAL_CYCLES,
