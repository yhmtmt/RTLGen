...
- source_sweep: `runs/datasets/llm_decoder_eval_distilgpt2_prompt_stress_v1/decoder_quality_sweep__l2_decoder_distilgpt2_prompt_stress_v1.json`
...
|---|---:|---:|---|
| `grid_approx_pwl_bf16_path` | 96/96 | 96/96 |  |
