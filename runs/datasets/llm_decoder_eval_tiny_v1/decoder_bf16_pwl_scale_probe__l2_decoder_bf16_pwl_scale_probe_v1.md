...
- source_sweep: `runs/datasets/llm_decoder_eval_tiny_v1/decoder_quality_sweep__l2_decoder_bf16_pwl_scale_probe_v1.json`
...
|---|---:|---:|---|
| `grid_approx_pwl_bf16_path` | 78/80 | 80/80 | `scale_arith_three_plus_five`, `scale_sequence_months` |
| `grid_approx_pwl_bf16_path_logit_tiebreak` | 80/80 | 80/80 |  |

- recovered_sample_ids: `scale_arith_three_plus_five`, `scale_sequence_months`
