...
- best requested logic slack um2: `236882.0692`
- best requested compute area over budget um2: `0.0`
- best requested required compute density gain: `0.999407`
- best requested compute substitution: `True`
- best requested substituted compute arch: `attention_dual_stream_composed_int8_q8k8v8_16x8_p8_ppc2_nohash_score32_w16_exact_div_split2`
- best requested substituted compute variant: `attention_dual_stream_composed_int8_q8k8v8_16x8_p8_ppc2_nohash_score32_w16_exact_div_split2`
- best requested substituted compute area um2: `399282750.0`
...
|---|---:|---:|---|---|---|---:|---:|---:|---:|---:|---:|
| dual_mac | 1575.373891 | 1.357672 | True | True | attention_dual_stream_composed_int8_q8k8v8_16x8_p8_ppc2_nohash_score32_w16_exact_div_split2 | 236882.0692 | 0.0 | 0.999407 | 745 | 745 | 532608 |

## Rows

| mode | latency us | area fit | feasible | substituted variant | logic slack um2 | local datapath/cluster | compute area required |
|---|---:|---|---|---|---:|---:|---:|
| dual_mac | 1575.373891 | True | True | attention_dual_stream_composed_int8_q8k8v8_16x8_p8_ppc2_nohash_score32_w16_exact_div_split2 | 236882.0692 | 0.0 | 399282750.0 |
| split_mac | 2042.378179 | True | True | attention_dual_stream_composed_int8_q8k8v8_16x8_p8_ppc2_nohash_score32_w16_exact_div_split2 | 236882.0692 | 0.0 | 399282750.0 |
| shared_mac | 2141.903683 | True | True | attention_dual_stream_composed_int8_q8k8v8_16x8_p8_ppc2_nohash_score32_w16_exact_div_split2 | 236882.0692 | 0.0 | 399282750.0 |
