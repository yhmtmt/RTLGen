...
- precision profile: `q8_k8_v8_a32_s32_w16_recip_lut_q16_int8_compute`
- source rows used: `3`
- physical feasible rows: `3`
- best requested mode: `dual_mac`
- best requested latency us: `1575.373891`
- best requested logic slack um2: `92088944.0692`
- best requested compute area over budget um2: `0.0`
- best requested required compute density gain: `0.769501`
- best requested compute substitution: `True`
- best requested substituted compute arch: `attention_dual_stream_composed_int8_q8k8v8_16x8_p8_ppc2_nohash_score32_w16_recip_lut_q16`
- best requested substituted compute variant: `attention_dual_stream_composed_int8_q8k8v8_16x8_p8_ppc2_nohash_score32_w16_recip_lut_q16`
- best requested substituted compute area um2: `307430688.0`
...
|---|---:|---:|---|---|---|---:|---:|---:|---:|---:|---:|
| dual_mac | 1575.373891 | 1.357672 | True | True | attention_dual_stream_composed_int8_q8k8v8_16x8_p8_ppc2_nohash_score32_w16_recip_lut_q16 | 92088944.0692 | 0.0 | 0.769501 | 856 | 1112 | 532608 |

## Rows

| mode | latency us | area fit | feasible | substituted variant | logic slack um2 | local datapath/cluster | compute area required |
|---|---:|---|---|---|---:|---:|---:|
| dual_mac | 1575.373891 | True | True | attention_dual_stream_composed_int8_q8k8v8_16x8_p8_ppc2_nohash_score32_w16_recip_lut_q16 | 92088944.0692 | 0.0 | 307430688.0 |
| split_mac | 2042.378179 | True | True | attention_dual_stream_composed_int8_q8k8v8_16x8_p8_ppc2_nohash_score32_w16_recip_lut_q16 | 92088944.0692 | 0.0 | 307430688.0 |
| shared_mac | 2141.903683 | True | True | attention_dual_stream_composed_int8_q8k8v8_16x8_p8_ppc2_nohash_score32_w16_recip_lut_q16 | 92088944.0692 | 0.0 | 307430688.0 |
