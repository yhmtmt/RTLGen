...
- precision profile: `q8_k8_v8_a24_s24_w16_exact_div_int8_compute`
- source rows used: `3`
- physical feasible rows: `3`
- best requested mode: `dual_mac`
- best requested latency us: `1575.373891`
- best requested logic slack um2: `47478504.0692`
- best requested compute area over budget um2: `0.0`
- best requested required compute density gain: `0.881161`
- best requested compute substitution: `True`
- best requested substituted compute arch: `attention_dual_stream_composed_int8_q8k8v8_16x8_p8_ppc2_nohash_score24_w16_exact_div`
- best requested substituted compute variant: `attention_dual_stream_composed_int8_q8k8v8_16x8_p8_ppc2_nohash_score24_w16_exact_div`
- best requested substituted compute area um2: `352041128.0`
...
|---|---:|---:|---|---|---|---:|---:|---:|---:|---:|---:|
| dual_mac | 1575.373891 | 1.357672 | True | True | attention_dual_stream_composed_int8_q8k8v8_16x8_p8_ppc2_nohash_score24_w16_exact_div | 47478504.0692 | 0.0 | 0.881161 | 856 | 971 | 532608 |

## Rows

| mode | latency us | area fit | feasible | substituted variant | logic slack um2 | local datapath/cluster | compute area required |
|---|---:|---|---|---|---:|---:|---:|
| dual_mac | 1575.373891 | True | True | attention_dual_stream_composed_int8_q8k8v8_16x8_p8_ppc2_nohash_score24_w16_exact_div | 47478504.0692 | 0.0 | 352041128.0 |
| split_mac | 2042.378179 | True | True | attention_dual_stream_composed_int8_q8k8v8_16x8_p8_ppc2_nohash_score24_w16_exact_div | 47478504.0692 | 0.0 | 352041128.0 |
| shared_mac | 2141.903683 | True | True | attention_dual_stream_composed_int8_q8k8v8_16x8_p8_ppc2_nohash_score24_w16_exact_div | 47478504.0692 | 0.0 | 352041128.0 |
