...
- model: `llm_decoder_frontier_synthesis_policy_calibrated_v1`

## Focus Summary

| shape | seq | dominant | share | attention_us | mlp_us | producer_ranker_us | attention choice | producer choice |
|---|---:|---|---:|---:|---:|---:|---|---|
| gpt2_medium_proxy | 32768 | output_projection_producer_ranker | 0.643553 | 221.712 | 0.432 | 401.42 | local_sram/mqa/kv8/hops0 | w128/k1/share1.0/ii1024 |
| gpt2_small | 32768 | output_projection_producer_ranker | 0.758926 | 95.4 | 0.162 | 301.065 | local_sram/mqa/kv8/hops0 | w128/k1/share1.0/ii768 |
...
- calibrated_row_count: `576`
- missing_wrapper_physical_rows: `288`
- producer_dominant_rows: `576`
- ranker_dominant_rows: `0`
- old_best_us: `5046.275694`
- calibrated_best_us: `301.065`
- old_to_calibrated_best_latency_speedup: `16.761416`
