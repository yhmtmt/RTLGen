...
- precision profile: `q8_k8_v6_a24_s12_w12_pwl_recip_q12_int8_compute`
- source rows used: `3`
- physical feasible rows: `0`
- best requested mode: `dual_mac`
- best requested latency us: `1575.373891`
- best requested logic slack um2: `-16751455.9308`
- best requested compute area over budget um2: `16751455.9308`
- best requested required compute density gain: `1.041929`
- best requested compute substitution: `True`
- best requested substituted compute arch: `attention_dual_stream_composed_int8_q8k8v6_16x8_p8_ppc2_nohash_softmax_q12_pwl_recip_q12`
- best requested substituted compute variant: `q12_pwl`
- best requested substituted compute area um2: `416271088.0`
...
|---|---:|---:|---|---|---|---:|---:|---:|---:|---:|---:|
| dual_mac | 1575.373891 | 1.357672 | False | True | q12_pwl | -16751455.9308 | 16751455.9308 | 1.041929 | 856 | 821 | 532608 |

## Rows

| mode | latency us | area fit | feasible | substituted variant | logic slack um2 | local datapath/cluster | compute area required |
|---|---:|---|---|---|---:|---:|---:|
| dual_mac | 1575.373891 | False | False | q12_pwl | -16751455.9308 | 0.0 | 416271088.0 |
| split_mac | 2042.378179 | False | False | q12_pwl | -16751455.9308 | 0.0 | 416271088.0 |
| shared_mac | 2141.903683 | False | False | q12_pwl | -16751455.9308 | 0.0 | 416271088.0 |
