...
- source rows used: `3`
- physical feasible rows: `6`
- best requested mode: `dual_mac`
- best requested latency us: `1575.373891`
- best requested logic slack um2: `102722176.0692`
- best requested compute area over budget um2: `0.0`
- best requested required compute density gain: `0.742886`
- best requested compute substitution: `True`
- best requested substituted compute arch: `attention_dual_stream_schedule_wrapper_score32_exp_lut_8x8_c2`
- best requested substituted compute variant: `attention_dual_stream_schedule_wrapper_score32_exp_lut_8x8_c2`
- best requested substituted compute kind: `dual_stream_schedule_wrapper`
- best requested substituted compute semantic profile: `score32_exp_lut_div`
- best requested substituted compute area um2: `296797456.0`
...
|---|---:|---:|---|---|---|---|---:|---:|---:|---:|---:|---:|
| dual_mac | 1575.373891 | 1.357672 | True | True | attention_dual_stream_schedule_wrapper_score32_exp_lut_8x8_c2 | score32_exp_lut_div | 102722176.0692 | 0.0 | 0.742886 | 428 | 576 | 532608 |
...
|---|---:|---|---|---|---|---|---:|---:|---:|
| dual_mac | 1575.373891 | True | True | attention_dual_stream_schedule_wrapper_score32_exp_lut_8x8_c2 | score32_exp_lut_div | None | 102722176.0692 | 0.0 | 296797456.0 |
| dual_mac | 1575.373891 | True | True | attention_dual_stream_schedule_wrapper_score32_exp_lut_8x8_c4 | score32_exp_lut_div | None | 104229592.0692 | 0.0 | 295290040.0 |
| split_mac | 2042.378179 | True | True | attention_dual_stream_schedule_wrapper_score32_exp_lut_8x8_c2 | score32_exp_lut_div | None | 102722176.0692 | 0.0 | 296797456.0 |
| split_mac | 2042.378179 | True | True | attention_dual_stream_schedule_wrapper_score32_exp_lut_8x8_c4 | score32_exp_lut_div | None | 104229592.0692 | 0.0 | 295290040.0 |
| shared_mac | 2141.903683 | True | True | attention_dual_stream_schedule_wrapper_score32_exp_lut_8x8_c2 | score32_exp_lut_div | None | 102722176.0692 | 0.0 | 296797456.0 |
| shared_mac | 2141.903683 | True | True | attention_dual_stream_schedule_wrapper_score32_exp_lut_8x8_c4 | score32_exp_lut_div | None | 104229592.0692 | 0.0 | 295290040.0 |
