`timescale 1ns/1ps
module decoder_r64_k1_serial_rank_lpc2_wrapper(
  input clk,
  input rst_n,
  input in_valid,
  output in_ready,
  ...
  logit_rank_r2_l16_k1 chunk_rank (
    .logits(chunk_logits),
