`timescale 1ns/1ps
module decoder_r64_k1_serial_rank_lpc4_wrapper(
  input clk,
  input rst_n,
  input in_valid,
  output in_ready,
  ...
  wire [1:0] chunk_top_index;
  wire signed [15:0] chunk_top_logit;
  logit_rank_r4_l16_k1 chunk_rank (
    .logits(chunk_logits),
    .top_indices(chunk_top_index),
    .top_logits(chunk_top_logit)
  );
  wire [15:0] chunk_top_token_id = chunk_base_token_id + { 14'd0, chunk_top_index };
