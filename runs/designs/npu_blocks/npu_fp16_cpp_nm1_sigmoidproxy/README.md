...
Reduced integrated physical proxy for the fixed `nm1` fp16 GEMM plus int8
sigmoid vec path.

- source config: `runs/designs/npu_blocks/npu_fp16_cpp_nm1_sigmoidproxy/config_nm1_sigmoidproxy.json`
- top module: `npu_sigmoid_proxy_top`
