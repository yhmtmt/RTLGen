# NPU E2E Evaluation Campaign: `mlp_smoke_v2` Reuse

This campaign is a scaffold for the next benchmark-set revision.

What it does:
- uses a new model-set identity (`mlp_smoke_v2`),
...
python3 npu/eval/optimize_campaign.py \
  --campaign runs/campaigns/npu/e2e_eval_mlp_smoke_v2_reuse/campaign.json \
  --profiles_json runs/campaigns/npu/e2e_eval_mlp_smoke_v2_reuse/objective_profiles.json
```

Notes:
- Replace `runs/models/mlp_smoke_v2/*` with broader ONNX benchmark models in
