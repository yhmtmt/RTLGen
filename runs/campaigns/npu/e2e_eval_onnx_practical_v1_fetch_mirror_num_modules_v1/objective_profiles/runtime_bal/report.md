# Campaign Report: npu_e2e_eval_onnx_practical_v1_fetch_mirror_num_modules_v1

- generated_utc: `2026-03-06T08:19:27+00:00`
- model_set_id: `onnx_practical_v1_fetch_mirror_v1`
- model_manifest: `runs/models/onnx_practical_v1_fetch_mirror_v1/manifest.json`
- physical_source_campaign: `runs/campaigns/npu/e2e_eval_v0/campaign.json`
- results_csv: `runs/campaigns/npu/e2e_eval_onnx_practical_v1_fetch_mirror_num_modules_v1/results.csv`
- summary_csv: `runs/campaigns/npu/e2e_eval_onnx_practical_v1_fetch_mirror_num_modules_v1/objective_profiles/runtime_bal/summary.csv`
- pareto_csv: `runs/campaigns/npu/e2e_eval_onnx_practical_v1_fetch_mirror_num_modules_v1/objective_profiles/runtime_bal/pareto.csv`
- best_json: `runs/campaigns/npu/e2e_eval_onnx_practical_v1_fetch_mirror_num_modules_v1/objective_profiles/runtime_bal/best_point.json`
- total_rows: `60`
- ok_rows: `60`
- non_ok_rows: `0`
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | fp16_nm2 | flat_nomacro | 3 | 0.415665 | 0.8554 | 1485.6093 | 0.00017999 | 5.7013 | 2250000.0000 | 0.210414 | 829.8140 | 415.6120 |
| 2 | fp16_nm1 | flat_nomacro | 3 | 0.622421 | 0.8796 | 1450.3448 | 0.00016987 | 5.5570 | 2250000.0000 | 0.193122 | 848.4180 | 424.7380 |
| 3 | fp16_nm2 | hier_macro | 3 | 1.500000 | 0.8554 | 1485.6093 | 0.00018204 | 5.7409 | 2250000.0000 | 0.212815 | 981.7820 | 452.3540 |
| 4 | fp16_nm1 | hier_macro | 3 | 1.636989 | 0.8796 | 1450.3448 | 0.00017366 | 5.7749 | 2250000.0000 | 0.197441 | 978.8940 | 480.1040 |
