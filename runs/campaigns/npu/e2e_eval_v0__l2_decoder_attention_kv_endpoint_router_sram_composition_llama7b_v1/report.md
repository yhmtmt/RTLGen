# Campaign Report: npu_e2e_eval_minimal_v0

- generated_utc: `2026-06-09T08:52:50+00:00`
- model_set_id: `mlp_smoke_v0`
- model_manifest: `runs/models/mlp_smoke_v0/manifest.json`
- results_csv: `runs/campaigns/npu/e2e_eval_v0__l2_decoder_attention_kv_endpoint_router_sram_composition_llama7b_v1/results.csv`
- summary_csv: `runs/campaigns/npu/e2e_eval_v0__l2_decoder_attention_kv_endpoint_router_sram_composition_llama7b_v1/summary.csv`
- pareto_csv: `runs/campaigns/npu/e2e_eval_v0__l2_decoder_attention_kv_endpoint_router_sram_composition_llama7b_v1/pareto.csv`
- best_json: `runs/campaigns/npu/e2e_eval_v0__l2_decoder_attention_kv_endpoint_router_sram_composition_llama7b_v1/best_point.json`
- total_rows: `20`
- ok_rows: `20`
- non_ok_rows: `0`
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | fp16_nm1 | flat_nomacro | 1 | 0.000000 | 0.0043 | 233535.7310 | 0.00000083 | 5.5570 | 2250000.0000 | 0.193122 | 848.4180 | 424.7380 |
| 2 | fp16_nm1 | hier_macro | 1 | 0.025231 | 0.0043 | 233535.7310 | 0.00000085 | 5.7749 | 2250000.0000 | 0.197441 | 978.8940 | 480.1040 |
| 3 | fp16_nm2 | flat_nomacro | 1 | 1.975990 | 0.0073 | 136425.6480 | 0.00000154 | 5.7013 | 2250000.0000 | 0.210414 | 829.8140 | 415.6120 |
| 4 | fp16_nm2 | hier_macro | 1 | 2.000000 | 0.0073 | 136425.6480 | 0.00000156 | 5.7409 | 2250000.0000 | 0.212815 | 981.7820 | 452.3540 |

## Pareto Set (latency, energy, flow runtime)

| arch_id | macro_mode | latency_ms_mean | energy_mj_mean | flow_elapsed_s_mean |
|---|---|---:|---:|---:|
| fp16_nm1 | flat_nomacro | 0.0043 | 0.00000083 | 848.4180 |
| fp16_nm2 | flat_nomacro | 0.0073 | 0.00000154 | 829.8140 |
...
|---:|---|---|---:|---:|---:|
| 1 | fp16_nm1 | flat_nomacro | 0.0043 | 0.00000083 | 848.4180 |
| 2 | fp16_nm1 | hier_macro | 0.0043 | 0.00000085 | 978.8940 |
| 3 | fp16_nm2 | flat_nomacro | 0.0073 | 0.00000154 | 829.8140 |
| 4 | fp16_nm2 | hier_macro | 0.0073 | 0.00000156 | 981.7820 |
